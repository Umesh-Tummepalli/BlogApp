...
/**
 * A component for uploading and previewing a single video file.
 * It handles video preview, selection, and removal.
 *
 * @param {object} props - The component props.
 * @param {File} props.value - The selected video File object (or null).
 ...
 */
const VideoUploader = React.memo(({ value, handleInputChange, index }) => {
...
// ✨ PropTypes make your component's API clear and help catch bugs.
...
// Set a default value for the `value` prop to avoid issues if it's undefined.
